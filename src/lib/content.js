...
export const brand = {
  ...
  nameShort: 'Kfz-Experten Hannover',
  tagline: 'Kfz-Gutachter & Sachverständiger · Hannover',
  city: 'Hannover',
...
export const heroDamagePoints = [
  ...
  { id: 2, x: 72, y: 58, label: 'Scheinwerfer links', damage: 'Streuscheibe gerissen, Halterung gebrochen', repair: '1.180 €', depreciation: '—', severity: 'Mittel' },
  { id: 3, x: 66, y: 75, label: 'Front-Stoßfänger links', damage: 'Verformung, Lackschaden, Clip-Halter gerissen', repair: '1.650 €', depreciation: '290 €', severity: 'Mittel' },
